...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("hello"));    // adding tabs to tab layout (tabs are new object so  newTab() .. n they are getting created inside the layout so..they are connected..so you initlize object like tablayout.addTab()
        tabLayout.addTab(tabLayout.newTab().setText("Second Tab"));
        tabLayout.setTabGravity(TabLayout.GRAVITY_CENTER);
        tabLayout.setTabTextColors(getResources().getColor(R.color.parrot), getResources().getColor(R.color.parrot));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                tabLayout.setTabTextColors(getResources().getColor(R.color.parrot), getResources().getColor(R.color.white));//here first parrot color is used for past tab and white color is used for current tab
